      ...
      <div className="relative z-10 container mx-auto px-4 text-center flex flex-col items-center max-w-5xl">
        ...
        <div className="mb-8 relative group">
          ...
          <img
            src={kryptoniteLogo}
            alt="Kryptonite Logo"
            className="relative w-32 h-32 md:w-48 md:h-48 mx-auto drop-shadow-[0_0_15px_rgba(0,255,136,0.5)] transition-transform duration-500 group-hover:scale-110"
          />
        </div>

        {/* Badge */}
        <div className="inline-flex items-center gap-2 px-4 py-1.5 mb-8 rounded-full border border-primary/30 bg-primary/5 backdrop-blur-md hover:bg-primary/10 transition-colors cursor-default animate-in fade-in slide-in-from-bottom-4 duration-700">
          <Trophy className="w-4 h-4 text-primary animate-pulse" />
          <span className="text-sm font-bold text-primary tracking-wide uppercase">APOC Champions</span>
        </div>

        {/* Main Title */}
        <h1 className="text-6xl md:text-8xl lg:text-9xl font-black mb-6 tracking-tighter animate-in fade-in slide-in-from-bottom-6 duration-1000">
        ...
        {/* Team Number */}
        <div className="mb-8 animate-in fade-in slide-in-from-bottom-8 duration-1000 delay-100">
          <span className="text-3xl md:text-4xl font-bold text-white/80 tracking-widest font-mono border-b-2 border-primary/50 pb-1">
            #28078
          </span>
        </div>

        {/* Description */}
        <p className="text-lg md:text-2xl text-muted-foreground mb-10 max-w-3xl mx-auto leading-relaxed animate-in fade-in slide-in-from-bottom-10 duration-1000 delay-200">
        ...
        <div className="flex flex-col sm:flex-row gap-6 justify-center items-center animate-in fade-in slide-in-from-bottom-12 duration-1000 delay-300">
          <Button
            ...
            className="h-14 px-8 text-lg bg-primary text-black font-bold hover:bg-primary/90 shadow-[0_0_30px_rgba(0,255,136,0.4)] hover:shadow-[0_0_50px_rgba(0,255,136,0.6)] hover:scale-105 transition-all duration-300 rounded-full"
          >
            Meet the Team
          ...
          <Button
            ...
            className="h-14 px-8 text-lg border-primary/50 text-primary hover:bg-primary/10 hover:border-primary backdrop-blur-sm rounded-full transition-all duration-300"
          >
            Our Achievements
          </Button>
        </div>
